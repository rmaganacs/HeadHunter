...
const CharacterBanners = () => {
    return (
      <Box className='position'>
        {/* Sova */}
        <Box className="bannerPostion" sx={{mt: "300px"}}>
          ...
          <Typography // Sova's Description
            ...
            sx={{fontSize: 25, paddingLeft: "380px", paddingTop: "200px"}}
            color={"white"}>
        ...
        {/* Chamber */}
        <Box className="bannerPostion" sx={{mt: "670px"}}>
          ...
          <Typography // Chamber's Description
            ...
            align='left'
            style={{ wordWrap: "break-word" }}
            sx={{fontSize: 25, paddingRight: "320px", paddingTop: "200px"}}
            color={"white"}>
